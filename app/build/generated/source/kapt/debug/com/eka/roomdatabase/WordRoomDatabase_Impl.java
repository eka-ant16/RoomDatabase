  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd23a08a5dc269be3aaabd582f8186906')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsWordTable.put("word", new TableInfo.Column("word", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoWordTable.equals(_existingWordTable)) {
          return new RoomOpenHelper.ValidationResult(false, "word_table(com.eka.roomdatabase.Word).\n"
                  + " Expected:\n" + _infoWordTable + "\n"
                  + " Found:\n" + _existingWordTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "d23a08a5dc269be3aaabd582f8186906", "d35b8f1bacddbbdac6402852f1af929f");
